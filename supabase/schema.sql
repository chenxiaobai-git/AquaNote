...
-- ALTER ROLE "authenticator" WITH NOINHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:Ao80bmmX0bcIPh3caeyaTw==$WwS16s/OcwRvEWnB6UietA6mrJ71IAgHgLUCejV8LG8=:ifSa3Uupqh38pXgqW8S6pIhWXcaQsO7rrvR9Kl+dMNA=';
-- CREATE ROLE "dashboard_user";
-- ALTER ROLE "dashboard_user" WITH INHERIT CREATEROLE CREATEDB NOLOGIN REPLICATION NOBYPASSRLS;
-- CREATE ROLE "pgbouncer";
-- ALTER ROLE "pgbouncer" WITH INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:uVGg7jzp19tHy/otZzhGNg==$bql3o1T/63JmqcDZUneX18c1xpV1prVhLs5LwTm/NkM=:6TPZrcRv+J3VjtKdaf+omPjHTmYu+69GRnrGlc5ETIc=';
-- CREATE ROLE "postgres";
-- ALTER ROLE "postgres" WITH INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:Aj1GrU9eiSSSvfFh0qRn2w==$s+PQD4rrEGlsA+ElSCZp5E3mXIaXRX05PxpJa1ObnOs=:aP1LFhsfChUAEFyxhwyH+3tDbt5JaOcTiiN6OIAvQMo=';
-- CREATE ROLE "service_role";
-- ALTER ROLE "service_role" WITH INHERIT NOCREATEROLE NOCREATEDB NOLOGIN BYPASSRLS;
-- CREATE ROLE "supabase_admin";
-- ALTER ROLE "supabase_admin" WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:3bhAIsI3OU2JIkQwO/i+tQ==$XooQC5v7STDDLjstN0oTnZ6c0F/F2SdBfS6BF3wkkxg=:92EHaMl1XgKnOyRzEANL3KIHhorex3nLhGQXJUfdvTQ=';
-- CREATE ROLE "supabase_auth_admin";
-- ALTER ROLE "supabase_auth_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:KU0oRGOlFIlCBlEhX95lFw==$QlRwtEizPav7WWT7Q4pmZezb1xmejNYm9HbmamZ0qxY=:vOuhrtp0MmZhYn8uQiOFT84wAFFucFJHfYJ7GbY5JEs=';
-- CREATE ROLE "supabase_functions_admin";
-- ALTER ROLE "supabase_functions_admin" WITH SUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:sDDYnMFLNLCH2VBEarGOgQ==$6prdGgznRUNIzDy6eLDzenxFMrXYNblPGB7ftRn2TSE=:JhcoFMiuc/vtb8oX4LnzdioR9YmSDZ5g6it7wi2KFck=';
...
-- ALTER ROLE "supabase_storage_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:leO9g4x9AhLUUXY7DMd/LQ==$vp/2Kp7rwCkPybTHVNP9DYT7MzPC5ZIkOKJg191UyF4=:HmlNL7+M5Sy5xup4Gqz8ScFBumfCbe6hjsTgCO0Ymzc=';
...
--
-- Name: anon_credential_map; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE "public"."maintenance_tasks" (
    ...
    "workspace_id" "uuid" NOT NULL,
    "title" "text" NOT NULL,
    "task_type" "text" DEFAULT '其他'::"text" NOT NULL,
    "due_date" "date",
...
--
-- Name: parameter_templates; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE "public"."profiles" (
    ...
    "email" "text",
    "phone" "text",
    "nickname" "text" DEFAULT '探索者'::"text" NOT NULL,
...
--
-- Name: water_quality_records; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: anon_credential_map anon_credential_map_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."anon_credential_map"
    ADD CONSTRAINT "anon_credential_map_pkey" PRIMARY KEY ("credential_id");
...
--
-- Name: parameter_templates parameter_templates_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."parameter_templates"
    ADD CONSTRAINT "parameter_templates_pkey" PRIMARY KEY ("id");
...
--
-- Name: water_quality_records water_quality_records_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."water_quality_records"
    ADD CONSTRAINT "water_quality_records_pkey" PRIMARY KEY ("id");
...
--
-- Name: chronicles chronicles_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: maintenance_tasks maintenance_tasks_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: organisms organisms_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: parameter_templates parameter_templates_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: supplies supplies_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: todos todos_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: anon_credential_map anon_credential_map_auth_uid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."anon_credential_map"
    ADD CONSTRAINT "anon_credential_map_auth_uid_fkey" FOREIGN KEY ("auth_uid") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;


--
-- Name: chronicles chronicles_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."chronicles"
    ADD CONSTRAINT "chronicles_workspace_id_fkey" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE CASCADE;


--
-- Name: maintenance_tasks maintenance_tasks_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."maintenance_tasks"
    ADD CONSTRAINT "maintenance_tasks_workspace_id_fkey" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE CASCADE;


--
-- Name: organisms organisms_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."organisms"
    ADD CONSTRAINT "organisms_workspace_id_fkey" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE CASCADE;


--
-- Name: parameter_templates parameter_templates_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."parameter_templates"
    ADD CONSTRAINT "parameter_templates_workspace_id_fkey" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE CASCADE;
...
--
-- Name: supplies supplies_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."supplies"
    ADD CONSTRAINT "supplies_workspace_id_fkey" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE CASCADE;


--
-- Name: todos todos_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."todos"
    ADD CONSTRAINT "todos_workspace_id_fkey" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE CASCADE;


--
-- Name: water_quality_records water_quality_records_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."water_quality_records"
    ADD CONSTRAINT "water_quality_records_workspace_id_fkey" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE CASCADE;
...
--
-- Name: chronicles Users can CRUD own chronicles; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can CRUD own chronicles" ON "public"."chronicles" TO "authenticated" USING (("workspace_id" IN ( SELECT "workspaces"."id"
   FROM "public"."workspaces"
  WHERE ("workspaces"."user_id" = "auth"."uid"()))));


--
-- Name: maintenance_tasks Users can CRUD own maintenance tasks; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can CRUD own maintenance tasks" ON "public"."maintenance_tasks" TO "authenticated" USING (("workspace_id" IN ( SELECT "workspaces"."id"
   FROM "public"."workspaces"
  WHERE ("workspaces"."user_id" = "auth"."uid"()))));


--
-- Name: organisms Users can CRUD own organisms; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can CRUD own organisms" ON "public"."organisms" TO "authenticated" USING (("workspace_id" IN ( SELECT "workspaces"."id"
   FROM "public"."workspaces"
  WHERE ("workspaces"."user_id" = "auth"."uid"()))));


--
-- Name: parameter_templates Users can CRUD own parameter templates; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can CRUD own parameter templates" ON "public"."parameter_templates" TO "authenticated" USING (("workspace_id" IN ( SELECT "workspaces"."id"
   FROM "public"."workspaces"
  WHERE ("workspaces"."user_id" = "auth"."uid"()))));


--
-- Name: supplies Users can CRUD own supplies; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can CRUD own supplies" ON "public"."supplies" TO "authenticated" USING (("workspace_id" IN ( SELECT "workspaces"."id"
   FROM "public"."workspaces"
  WHERE ("workspaces"."user_id" = "auth"."uid"()))));


--
-- Name: todos Users can CRUD own todos; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can CRUD own todos" ON "public"."todos" TO "authenticated" USING (("workspace_id" IN ( SELECT "workspaces"."id"
   FROM "public"."workspaces"
  WHERE ("workspaces"."user_id" = "auth"."uid"()))));


--
-- Name: water_quality_records Users can CRUD own water quality records; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can CRUD own water quality records" ON "public"."water_quality_records" TO "authenticated" USING (("workspace_id" IN ( SELECT "workspaces"."id"
   FROM "public"."workspaces"
  WHERE ("workspaces"."user_id" = "auth"."uid"()))));


--
-- Name: workspaces Users can CRUD own workspaces; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can CRUD own workspaces" ON "public"."workspaces" TO "authenticated" USING (("user_id" = "auth"."uid"()));
...
--
-- Name: anon_credential_map; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: maintenance_tasks; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."maintenance_tasks" ENABLE ROW LEVEL SECURITY;

--
-- Name: organisms; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."organisms" ENABLE ROW LEVEL SECURITY;

--
-- Name: parameter_templates; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: water_quality_records; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: profiles 用户可更新自己的档案; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "用户可更新自己的档案" ON "public"."profiles" FOR UPDATE TO "authenticated" USING (("auth"."uid"() = "id")) WITH CHECK (("auth"."uid"() = "id"));


--
-- Name: profiles 用户可查看自己的档案; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "用户可查看自己的档案" ON "public"."profiles" FOR SELECT TO "authenticated" USING (("auth"."uid"() = "id"));


--
-- Name: admin_logs 管理员可读写日志; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "管理员可读写日志" ON "public"."admin_logs" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."admin_emails"
  WHERE ("admin_emails"."email" = (( SELECT "users"."email"
           FROM "auth"."users"
...
--
-- Name: system_config 管理员可读系统配置; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "管理员可读系统配置" ON "public"."system_config" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."admin_emails"
  WHERE ("admin_emails"."email" = (( SELECT "users"."email"
           FROM "auth"."users"
          WHERE ("users"."id" = "auth"."uid"())))::"text"))));
...
--
-- Name: admin_emails 自查管理员身份; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "自查管理员身份" ON "public"."admin_emails" FOR SELECT TO "authenticated" USING (("email" = (( SELECT "users"."email"
   FROM "auth"."users"
  WHERE ("users"."id" = "auth"."uid"())))::"text"));
...
--
-- Name: supabase_realtime maintenance_tasks; Type: PUBLICATION TABLE; Schema: public; Owner: -
--
...
--
-- Name: supabase_realtime water_quality_records; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."water_quality_records";
